...
template <>
int kr_transpose_0213<float>(const float* src, float* target, const size_t a, const size_t b, const size_t c, const size_t d, hipStream_t stream) {
...
template <>
int kr_transpose_0213<__half>(const __half* src, __half* target, const size_t a, const size_t b, const size_t c, const size_t d, hipStream_t stream) {
    int nElementNumber = a * b * c * d;
...
template <>
int kr_transpose_0213_repeated<float>(const float* src, float* target, const size_t a, const size_t b, const size_t cf, const size_t ct, const size_t d, hipStream_t stream) {
...
template <>
int kr_transpose_0213_repeated<__half>(const __half* src, __half* target, const size_t a, const size_t b, const size_t cf, const size_t ct, const size_t d, hipStream_t stream) {
    int nElementNumber = a * b * ct * d;
