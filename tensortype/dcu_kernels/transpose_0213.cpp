...
template <>
int kr_transpose_0213<float>(const float* src, float* target, int a, int b, int c, int d, hipStream_t stream) {
...
template <>
int kr_transpose_0213<__half>(const __half* src, __half* target, int a, int b, int c, int d, hipStream_t stream) {
    int nElementNumber = a * b * c * d;
